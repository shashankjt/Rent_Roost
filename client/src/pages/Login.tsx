...
const Login = () => {
    ...
    return (
        <div className="max-w-md mx-auto bg-white p-8 rounded-2xl shadow-xl border border-gray-100 mt-10">
            ...
            <p className="text-center text-gray-500 mb-8">Sign in to continue to RentRoost</p>
            ...
            <p className="text-center mt-6 text-sm text-gray-600">
                ...
                <Link to="/signup" className="text-indigo-600 font-semibold hover:text-indigo-800">Sign up</Link>
            </p>
        </div>
    );
};
